...
public class CartDto {
    ...
    public CartItemDto findItemByProductId(Long productId) {
        return items.stream()
    ...
    public List<CartItemDto> getUnavailableItems() {
        return items.stream()
                .filter(item -> !item.isAvailable())
                .toList();
    }
    
    public List<CartItemDto> getItemsWithInsufficientStock() {
        return items.stream()
                .filter(CartItemDto::hasInsufficientStock)
                .toList();
    }
    ...
    public boolean hasInsufficientStockItems() {
        return items.stream().anyMatch(CartItemDto::hasInsufficientStock);
    }
